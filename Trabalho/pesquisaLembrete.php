				...
				<div class="col-md-8 col-md-offset-2">
					...
					<!-- <form class="navbar-form" role="search" method="POST" action="pesquisaLembrete.php">
						<div class="input-group">
								...
								<input type="text" size="40" class="form-control" placeholder="Digite algo sobre o Lembrete" name="pesquisa">
								<div class="input-group-btn">
									<button class="btn btn-default" type="submit" value="Pesquisar"><i class="glyphicon glyphicon-search"></i></button>
								</div>
						</div>
					</form> -->
					<form class="navbar-form" role="search" method="POST" action="lembretes.php">
						<div class="input-group">
								<div class="input-group-btn">
									<button type="submit" class="btn btn-default" value="Voltar">Voltar a Lista Completa</button>
								</div>
						</div>
					</form>		
					<br>
							...
							<tbody>
								<?php
									...
									if (isset($_SESSION['nome']) and isset($_SESSION['senha'])){		
										...
										$resultado = $lembrete->pesquisarLembrete($pesquisa);
